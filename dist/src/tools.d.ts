...
export declare const MINGLE_TOOL_NAMES: readonly ["mingle_send_dm", "mingle_read_conversation", "mingle_list_channels", "mingle_read_channel", "mingle_post_channel", "mingle_find_matches", "mingle_propose_introduction", "mingle_list_introductions", "mingle_respond_introduction", "mingle_get_profile", "mingle_update_profile"];
